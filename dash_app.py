...
recommendations = [
    "Пересмотрите тарифные планы и сравните с соседями.",
    "Проверьте исправность приборов учёта электроэнергии и воды.",
    "Используйте энергоэффективные лампы и бытовую технику.",
    "Регулярно проводите ревизию сантехники для устранения утечек.",
    "Оптимизируйте отопление: проверьте окна, двери и изоляцию.",
    "Разделяйте горячую и холодную воду при расчёте, чтобы снизить перерасход.",
    "Сортируйте отходы и уменьшите образование ТКО, если возможно.",
    "Сравните расходы с соседями, чтобы определить возможные зоны экономии."
]
import random
for rec in random.sample(recommendations, 5):
    st.write(f"- {rec}")
